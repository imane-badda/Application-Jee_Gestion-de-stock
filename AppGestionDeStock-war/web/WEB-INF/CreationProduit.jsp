                    ...
                    <div class="container-fluid login">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-8 col-xs-12" style="margin-top: 10px; border : 2px solid rgba(0, 0, 0, 0.150); padding: 40px; padding-top: 10px; padding-bottom:  20px; margin-bottom:  20px; border-radius: 5px; ">
                                ...
                                <form  action="http://localhost:8080/AppGestionDeStock-war/CreationProduit" method="POST" class="form-con">
                                        <div class="mb-3 InputFormArticl">
                                          <label  class="form-label">Référence </label>
                                          <input type="text" class="form-control" name = "reference" placeholder="Nom..." id="" aria-describedby="">
                                        </div>
                                        <div class="mb-3 InputFormArticl">
                                        ...
                                        <div class="mb-3 InputFormArticl">
                                          ...
                                          <input type="text" class="form-control" name = "denomination" placeholder="dénomination..." id="" aria-describedby="">
                                        </div>
                                        <div class="mb-3 InputFormArticl">
                                          <label  class="form-label">Prix</label>
                                          <input type="text" class="form-control" name = "prix" placeholder="prix..." id="" aria-describedby="">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-4 col-xs-0">  
                                                <div class="mb-3 InputFormArticl">
                                                   <label  class="form-label">Poids</label>
                                                    <input type="text" class="form-control" name = "poids" placeholder="poids..." id="" aria-describedby="">
                                                </div>
                                            </div> 
                                            <div class="col-md-6 col-sm-4 col-xs-0">
                                                <div class="mb-3 InputFormArticl">
                                                    <label  class="form-label">Volume</label>
                                                    <input type="text" class="form-control" name = "volume" placeholder="volume..." id="" aria-describedby="">
                                                </div>
                                            </div>
                                        </div>
